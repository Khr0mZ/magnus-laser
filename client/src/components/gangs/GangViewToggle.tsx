...
import { pulseGlow, pulseGlowBlue, pulseGlowCyan } from './GangAnimations'
...
const GangViewToggle = ({ compactView, onViewChange, disabled }: ViewToggleProps) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {t('common.detailedView', 'Grid')}
            </ToggleButton>
        </ToggleButtonGroup>
    )
}

export default GangViewToggle
