...
import { buttonGlitch, flicker, glitch } from '../Animations'
...
const ImageField = ({
    ...
    return (
        ...
        >
            <Avatar
                src={image || undefined}
                alt={t('common.itemImageAlt', { name })}
                variant="rounded"
                slotProps={{
                    img: {
                        style: {
            ...
            >
                ...
                >
                    <Typography
                        ...
                        variant="body2"
                        sx={{
                            color: !image ? 'grey' : readerMode ? '#d32f2f' : colors.neons.red.default,
                            textShadow: !image ? 'none' : readerMode ? 'none' : `0 0 5px ${colors.neons.red.default}`,
                            zIndex: 2,
                            fontWeight: 'bold',
                            fontSize: '16px',
                            lineHeight: 1,
                ...
                {handleRegenerateClick && (
                    ...
                    >
                        <AutorenewIcon
                            className="icon-content"
                            sx={{
                                color: !canRegenerate ? 'grey' : readerMode ? '#2e7d32' : colors.neons.green.default,
                                textShadow: !canRegenerate
                                    ? 'none'
                                    : readerMode
                                    ? 'none'
