...
export const generateRandomGang = (gang?: Partial<Gang>): Gang => {
    ...
    const nameCategory2 = getRandomElement(Object.values(GangNameType))
    ...
    const term2 = getRandomElement(category2Array)
    let gangName = ''
    if (nameCategory2 === GangNameType.ADJECTIVE || nameCategory2 === GangNameType.COLOR) {
        gangName = `The ${term2} ${term1}`
    } else {
        gangName = `The ${term1} ${term2}`
    }
    // Generate Gang Type
