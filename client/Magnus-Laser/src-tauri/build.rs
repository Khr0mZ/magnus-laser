...
fn generate_embedded_cloudflared() {
    // Store binaries in bin/ relative to src-tauri (not ../bin)
    // This makes include_bytes! work correctly from src/embedded_cloudflared.rs
    ...
    // The binary path is relative to src/embedded_cloudflared.rs
    // From src/embedded_cloudflared.rs, bin/ is at ../bin/
