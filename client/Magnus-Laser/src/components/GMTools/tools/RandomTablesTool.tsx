...
import { allGenerators, categories, formatResult } from './randomTablesData'
...
const RandomTablesTool = ({ hideResults }: RandomTablesToolProps) => {
        ...
        <Box>
            ...
            <Grid container spacing={1}>
                {categories.map((category) => (
                    <Grid size={{ xs: 6 }} key={category.key}>
                        <Accordion
                            key={category.key}
                ...
                <Grid size={{ xs: 6 }}>
                    <Accordion sx={accordionSx} disableGutters>
                        <AccordionSummary
                            expandIcon={
                                <ExpandMore
                                    sx={{ color: readerMode ? colors.grays.gray400 : colors.neons.red.default }}
                                />
                            }
                                    ...
                                    <FormControl size="small" sx={{ flex: 1 }}>
                                        ...
                                        >
                                            <MenuItem value="corporate">
                                                {t('soloPlay.tables.zones.corporate')}
                                            </MenuItem>
                                            <MenuItem value="moderate">{t('soloPlay.tables.zones.moderate')}</MenuItem>
                                            <MenuItem value="combatZone">
                                                {t('soloPlay.tables.zones.combatZone')}
                                            </MenuItem>
                                            <MenuItem value="outskirts">
                                                {t('soloPlay.tables.zones.outskirts')}
                                            </MenuItem>
                                        </Select>
                                    </FormControl>
                                    <FormControl size="small" sx={{ flex: 1 }}>
            ...
            {/* Results - hidden when used as embedded tab */}
            {!hideResults && (
                <>
